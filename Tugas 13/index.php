...
<html lang="en">
  ...
  <body>
    ...
    <div class="jumbotron jumbotron-fluid">
      <div class="container">
        <h1 class="display-4">Selamat datang di <br> Sistem Informasi Manajemen Akademik Universitas Udayana </h1>
      </div>
    </div>
    ...
    <section id="berita" class="content">
      <div class="container">
        ...
        <a target="_blank"
            href="https://www.unud.ac.id/in/berita3307-Polda-Bali-Kolaborasi-dengan-Universitas-Udayana-Ciptakan-Rasa-Aman-dan-Nyaman-Bagi-Masyarakat-di-Tengah-Pandemi-COVID-19.html"><br><br><br><br>Berita Lainnya</a>
      </div>
    </section>
